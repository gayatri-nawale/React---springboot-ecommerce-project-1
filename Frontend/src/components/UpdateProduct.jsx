    ...
    const fetchProduct = async () => {
      try {
       ...
       setUpdateProduct({
         ...
         stockQty: response.data.stockQty || "",
       });
      } catch (error) {
            ...
            <div className="card-body">
              ...
              <form className="row g-3" noValidate validated={validated.toString()} onSubmit={handleSubmit}>
                ...
                <div className="col-md-4">
                  ...
                  <input
                    type="number"
                    className={`form-control ${validated && errors.stockQty ? 'is-invalid' : ''}`}
                    onChange={handleChange}
                    ...
                    required
                  />
                  {errors.stockQty && <div className="invalid-feedback">{errors.stockQty
                      }</div>}
                </div>
